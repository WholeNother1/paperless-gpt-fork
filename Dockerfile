...
# rooth-patch 2026-05-06: bumped r9 -> r11 because alpine 3.21 repo ages out
# old patch versions; r9 is no longer available, build failed with
# "breaks: world[musl-dev=1.2.5-r9]". Watch for similar drift on the other
# pinned versions on each upstream pull.
